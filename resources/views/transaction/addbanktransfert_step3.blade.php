...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add Bank transfert - Validate transfert</h4>
                <form action="" method="post">
                    ...
                    <div id="wizard">
                        ...
                        <section>
                            ...
                            <div class="">
                                <a href="{{route('addbanktransfertstep2',["step"=>"2"])}}" class="btn btn-outline-secondary float-start"><i class="mdi mdi-arrow-left"></i> PREVIOUS</a>
